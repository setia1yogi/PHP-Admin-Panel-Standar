...
<form action="" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nim" placeholder="Masukan Nim Mahasiswa" name="nim" value="<?= $mahasiswa["nim"]; ?>" pattern="[0-9]{12}" title="Nim harus memiliki jumlah 12 dan berupa angka" required>
    </div>
    <div class="form-group">
